...
$config['upload_path'] = './uploads/'; // Make sure this directory exists and is writable
$config['allowed_types'] = 'gif|jpg|png'; // Add any other allowed file types as needed
$config['max_size'] = 100; // Maximum file size in kilobytes
$config['max_width'] = 1024; // Maximum width allowed for uploaded images
$config['max_height'] = 768; // Maximum height allowed for uploaded images
